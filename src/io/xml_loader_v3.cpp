...
bool XML_Loader_v3::load(QIODevice *input, Graph* graph)
{
    m_version = 0;
...
void XML_Loader_v3::load_style(QIODevice *input, Graph *graph)
{
...
int XML_Loader_v3::version()
{
    return m_version;
}


Node *XML_Loader_v3::get_node(QDomElement element)
{
...
Edge *XML_Loader_v3::get_edge(QDomElement element)
{
...
Node_Style XML_Loader_v3::get_node_style(QDomElement element, bool everything)
{
    Node_Style ns;
    if ( everything )
    {
...
Edge_Style XML_Loader_v3::get_edge_style(QDomElement element, bool everything)
{
    Edge_Style es;
...
void XML_Loader_v3::get_style(QDomElement e_style, Graph *graph)
{
    if ( e_style.isNull() )
        return;
...
void XML_Loader_v3::get_graph(QDomElement element, Graph *graph)
{
...
QColor XML_Loader_v3::get_color(QDomElement e)
{
    QColor c = Qt::black;
